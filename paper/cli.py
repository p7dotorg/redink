...
HELP = """\
redink — adversarial pre-submission paper red-teamer

Usage:
  redink <paper.md>           red-team a paper
  redink - < paper.md         read from stdin
  paper7 get 2401.12345 | redink -
